...
with open('./imlinucb.pkl', 'rb') as f:
...
os.chdir('results_fb4_16_un_std/')
...
ucbgr_std=pd.read_pickle("ucbgr.pkl")
...
for i in plot_T:
    ...
    ax.errorbar(x=[0,10000,20000,30000,40000,50000,60000,70000,80000,90000,100000], y=mean_plot[i], yerr=err_plot[i],capsize=10,lw=5, marker='D',markersize=15,label=i)
...
ax.get_figure().savefig('results_fb4_16_un/regret_plot_16.jpg')
