    ...
    if budget == 0:
        ...
        for i in range(len(combs_to_try)):
            ...
            for j in range(n_sim):
                ...
                try: 
                    influence[i] = influence_dict[tuple(sorted(set(spontaneously_infected_plus_ith_comb)))]                    
                except:
                    print('not found')
                    if diffusion_model == "independent_cascade":
                    ...
                    influence_dict[tuple(sorted(set(spontaneously_infected_plus_ith_comb)))] = influence[i]
