                ...
                for num_samples in nums_samples:
                    ...
                    for filename in os.listdir('../adaptive_im/results'+str(name_id)):
                        try:
                            ...
                            if (filename_split[0] == 'output_'+algorithm and filename_split[1] == epsilon and filename_split[2] == seed_set_size and filename_split[5] == stage_horizon):
                                #print(filename)
                                count = count + 1
...
output_adaptive.to_csv('results'+name_id+'/output_adaptive.csv',index=False,header=True)
