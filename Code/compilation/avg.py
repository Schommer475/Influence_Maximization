...
def main():
    ...
    for horizon in num_samples:
                ...
                for epsilon in epsilons:  
                    for stage_horizon in stage_horizons:
                        for num_samples in nums_samples:
                            ...
                            for filename in os.listdir(basepath):
                                try:
                                    ...
                                    if (filename_split[0] == 'output_'+algorithm and filename_split[1] == epsilon and 
                                        filename_split[2] == seed_set_size and filename_split[4]==str(horizon) and 
                                        filename_split[5] == stage_horizon):
                                        #print(filename)
                                        count = count + 1
                            ...
                            if count > 0:    
                                print(algorithm+'__'+seed_set_size+'__'+num_samples+'__'+epsilon+'__'\
                                      +stage_horizon+'__'+str(count))
        ...
        csv_path = os.path.join(output_dir, 'cmab'+str(horizon)+'.csv')
